...
FOTO_PATH = Path(
    "C:/Users/prosy/Desktop/PROJETOS/ecosystemmkt/BANCO IMAGENS/"
    "SEM FUNDO/pensao alimenticia.png"
)
OUT_DIR = Path(__file__).parent / "_teste_pensao_output"

PERGUNTA = "Dá pra descontar a pensão direto do salário do meu ex?"
ESPECIALIDADE = "Advogada | Letícia Barros | Direito de Família"
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        caminho = OUT_DIR / "criativo-pensao-alimenticia.png"
